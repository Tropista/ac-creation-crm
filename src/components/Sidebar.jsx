...
const menuItems = [
  ...
  { page: "atelier", label: "Atelier", icon: "🔧", type: "page" },
  ...
  { page: "tshirt3d", label: "Configurateur T-shirt 3D", icon: "👕", type: "page" },
  { page: "vue3d", label: "Configurateur Mug 3D", icon: "☕", type: "page" },
